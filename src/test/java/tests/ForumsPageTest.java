...
public class ForumsPageTest extends BasePage{
	...
	public void navigateToForumsPage() {
		...
		homePage.hoverOvercheckBoxPageTitleTab();
		logger.log(LogStatus.INFO, "Hovering over 'checkBoxPageTitle'");
		homePage.clickOncheckBoxTab();
		logger.log(LogStatus.INFO, "Clicking 'checkBox'");
		homePage.switchTabs();
